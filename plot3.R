## This script is to create plot 3 as required / described by Course Project 1 - Plotting of Cousera Exploratory Data Analysis
...
dev.size(units=c("px"))
dev.new(480,480)
plot(myData$DateTime, myData$Sub_metering_1, type="l", col="black", ylab="Energy sub meeting", xlab="")
